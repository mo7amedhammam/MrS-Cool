//
//  VerifyStudentNumberVM.swift
//  MrS-Cool
//
//  Created by wecancity on 29/03/2024.
//
...
class VerifyStudentNumberVM: ObservableObject {
...
extension VerifyStudentNumberVM{
    func SendVerifyOtp(){
...
//        guard let user = Helper.shared.getSelectedUserType() else {return}
        let target = Authintications.SendOtp(user: .Student, parameters: parameters)
        isLoading = true
