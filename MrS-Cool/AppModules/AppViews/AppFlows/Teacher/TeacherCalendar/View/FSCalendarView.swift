...
//                    print("Updated Events: \(events)")
        ...
        .bottomSheet(isPresented: $calendarschedualsvm.ShowAddExtraSession){
            VStack{
                ...
                ScrollView{
                    Group {
                        CustomDropDownField(iconName:"img_group_512380",placeholder: "Lesson", selectedOption: $calendarschedualsvm.extraLesson,options:[],Disabled: true)
                        ...
                        CustomDatePickerField(iconName:"img_maskgroup7cl",placeholder: "Start Time", selectedDateStr:$calendarschedualsvm.extraTime,timeZone:appTimeZone,datePickerComponent:.hourAndMinute,isvalid: calendarschedualsvm.isextraTimevalid)
