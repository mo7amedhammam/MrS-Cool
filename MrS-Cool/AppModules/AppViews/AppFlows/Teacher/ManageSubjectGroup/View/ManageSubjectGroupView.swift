                        ...
                        Group{
                            VStack(alignment: .leading, spacing: 0){
                                ...
                                Group {
                                    ...
                                    CustomDatePickerField(iconName:"img_group148",rightIconName: "img_daterange",placeholder: "Start Date", selectedDateStr:$groupsforlessonvm.date,datePickerComponent:.date)
                                        .overlay(content: {
