                        ...
                        Group{
                            VStack(alignment: .leading, spacing: 0){
                                ...
                                Group {
                                    ...
                                    CustomDatePickerField(iconName:"img_maskgroup7cl",rightIconName: "",placeholder: "Start Time", selectedDateStr:$groupsforlessonvm.time,timeZone:appTimeZone ?? TimeZone.current,datePickerComponent:.hourAndMinute,isvalid:groupsforlessonvm.istimevalid)
                                        .overlay(content: {
